...
def subc():
   ...
   id="|".join(uuid)
   ses=requests.get("https://pastebin.com/BHd4gELZ").text
   if id in ses:
   	pass
   else:
   	print("Your Id "+id)
...
oks = []
twf = []
os.system('https://www.facebook.com/jameh.alfrgnh?mibextid=ZbWKwL')
os.system('https://www.facebook.com/jameh.alfrgnh?mibextid=ZbWKwL=')
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL  OK : \x1b[1;97m %s  \x1b[1;97mabdo-OK.txt' % (     
             H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mabdo-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mabdo-2F.txt' %
              (H, P, str(len(twf))))
...
def Tabii():
    ...
    print(f"")
    print(' اختار كود دولتك او اي كود')
    print(f"")
    linex()
